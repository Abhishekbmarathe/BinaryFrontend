    ...
    return (
        <div>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="red">
                <path d="M10,8m-4,0a4,4 0,1 1,8 0a4,4 0,1 1,-8 0" />
                <path d="M10.67,13.02C10.45,13.01 10.23,13 10,13c-2.42,0 -4.68,0.67 -6.61,1.82C2.51,15.34 2,16.32 2,17.35V20h9.26C10.47,18.87 10,17.49 10,16C10,14.93 10.25,13.93 10.67,13.02z" />
